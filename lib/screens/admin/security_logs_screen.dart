...
class SecurityLogsScreen extends StatefulWidget {
  ...
  const SecurityLogsScreen({super.key, required this.adminData});
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              'Camera: ${log['camera_id'] ?? 'Main Entry'}',
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${isEntry ? 'Entry' : 'Exit'} • ${log['camera_id'] ?? 'Main'}',
                    style: GoogleFonts.outfit(
                      fontSize: 13,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'No activity found in the last 24h',
